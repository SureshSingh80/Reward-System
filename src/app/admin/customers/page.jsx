...
import { fetchAllCustomers, filterCustomer } from "@/utils/admin/fetchAllCustomers";
...
export default function ShowCustomers() {
  ...
  return (
    <div className="p-6  min-h-screen bg-gray-200 px-4 text-black">
    <ToastContainer/>
      ...
      <div className="overflow-x-auto rounded-lg shadow">
        <table className="w-full border-collapse">
          ...
          <tbody>
            {filteredCustomers.length > 0 ? (
              filteredCustomers.map((customer) => (
                ...
                >
                  ...
                  <td className="px-4 py-2">{customer?.phone ? customer?.phone : "N/A"}</td>
                  {/* <td className="px-4 py-2">{customer?.joined}</td> */}
                  <td className="px-4 py-2 text-center flex gap-2 justify-center">
                    <button
                      onClick={() => router.push(`https://mail.google.com/mail/?view=cm&fs=1&to=${customer?.email}`)}
                    ...
                    <button
                      onClick={() =>
                        router.push(`/admin/view-customer/${customer?._id}`)
                      }
            ...
            ): loading ? <tr><td colSpan="5" className="px-4 py-6 text-center text-gray-500 italic">Loading...</td></tr>  : (
              <tr>
                <td
                  colSpan="5"
