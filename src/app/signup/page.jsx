        ...
        // signUp(email,password);
         ...
         signUp(email,password).then(async(userCredential)=>{
            ...
            customer.c_id=user.uid;
             // call api to store data in backend
            try {
    ...
    return (
        <div className="w-full max-w-md mx-auto mt-10">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-white p-8 rounded shadow">
            ...
            {/* username */}
            <div>
              <label htmlFor="username" className="block mb-1 font-semibold text-gray-900" style={{ WebkitFontSmoothing: 'antialiased', MozOsxFontSmoothing: 'grayscale' }}>
                Username
              </label>
              <input
                id="username"
            ...
            {/* confirm password */}
            <div style={{position:'relative'}}>
              <label htmlFor="phoneNo" className="block mb-1 font-semibold text-gray-900" style={{ WebkitFontSmoothing: 'antialiased', MozOsxFontSmoothing: 'grayscale' }}>
                Confirm Password
              </label>
              <input
                id="confirmPassword"
            ...
            <button style={{cursor:'pointer'}} type="submit" className="w-full bg-blue-700 hover:bg-blue-800 text-white py-2 rounded font-semibold">
